...
- Name: audit-payments.spec.ts >> 11. Purchase label & audit trail — payments table >> the admin payments table shows the purchase label on each transaction
- Location: e2e/audit-payments.spec.ts:19:3
...
Locator: getByText('Two-Step Evaluation · $25,000', { exact: true })
Expected: visible
Error: strict mode violation: getByText('Two-Step Evaluation · $25,000', { exact: true }) resolved to 3 elements:
    1) <div class="mt-0.5 truncate max-w-[200px] text-[10px] font-medium text-emerald-600 dark:text-emerald-500">Two-Step Evaluation · $25,000</div> aka getByText('Two-Step Evaluation · $').first()
    2) <div class="mt-0.5 truncate max-w-[200px] text-[10px] font-medium text-emerald-600 dark:text-emerald-500">Two-Step Evaluation · $25,000</div> aka getByText('Two-Step Evaluation · $').nth(1)
    3) <div class="mt-0.5 truncate max-w-[200px] text-[10px] font-medium text-emerald-600 dark:text-emerald-500">Two-Step Evaluation · $25,000</div> aka getByText('Two-Step Evaluation · $').nth(2)

Call log:
  - Expect "toBeVisible" with timeout 15000ms
  - waiting for getByText('Two-Step Evaluation · $25,000', { exact: true })
